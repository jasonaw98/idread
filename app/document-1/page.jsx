...
const page = () => {
  return (
    <div className="w-full h-full flex flex-col bg- pt-12">
    ...
    <div className="flex w-full mt-9 relative bg- justify-evenly mb-8">
    ...
    <div className="w-full h-full flex flex-col bg-gray-200 rounded-3xl justify-between">
